...
void ArmorDetectorNode::createDebugPublishers() {
  ...
  binary_img_pub_ =
      image_transport::create_publisher(this, "/detector/armors_binary_img");
  number_img_pub_ =
      image_transport::create_publisher(this, "/detector/armors_number_img");
  result_img_pub_ =
      image_transport::create_publisher(this, "/detector/armors_result_img");
}
